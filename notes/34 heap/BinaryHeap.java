...
// Binary heap implementation with additional static methods
// for sorting an array using the heapsort algorithm. The methods 
// percolateUp and percolateDown are static in order to reuse 
// them in the heapsort methods. See main method at bottom for 
// a simple demo.
...
public class BinaryHeap<E extends Comparable<? super E>> {
	...
	// Comparator.
	public static <T> void heapSort(T[] data, final Comparator<? super T> comp) {
	...
	// heapsort algorithm.
	private static <T> void heapSortImpl(T[] data, Comparator<? super T> comp,
			final int size) {
	...
	private static <T> void heapify(T[] data, Comparator<? super T> comp,
			int size) {
	...
	// heap-ordered.
	private static <T> void percolateUp(T[] data, Comparator<? super T> comp,
			int current) {
	...
	private static <T> void percolateDown(T[] data, Comparator<? super T> comp,
	...
	public static void main(String[] args) {
		Integer[] arr = new Integer[] { 4, 4, 12, 8, 10, 2, 7, 18, 8, 1 };
